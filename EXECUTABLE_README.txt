PDF Slide Extraction API - Portable Windows Build
...
4. Double-click start_api.bat, or run PDFSlideExtractionAPI.exe directly.
...
If Windows blocks PDFSlideExtractionAPI.exe, your device has a policy for
